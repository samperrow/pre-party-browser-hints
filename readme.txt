...
1. Most recent update: September 1, 2020.
2. Version 1.7.3.1

September 1, 2020:
1) Modified how auto-preconnect hints are sent and received to require a hash value. This protects against cached
scripts, and replay attacks.
