...
class HintBuilderTest extends TestCase {
	...
	public function test_create_pprh_hint() {
		...
		$expected_10 = Utils::create_raw_hint( $url_10, 'preload', 1, '', '', 'crossorigin' );
...
//	public function test_get_file_type_mime() {
//		$actual_1 = self::$hint_builder->get_file_type_mime( 'https://asdf.com/adsf/sdflkasjfd/script.js?ver=23626262' );
//		self::assertSame( '.js', $actual_1 );
//
//		$actual_2 = self::$hint_builder->get_file_type_mime( 'https://asdf.com/adsf/sdflkasjfd/image.jpg' );
//		self::assertSame( '.jpg', $actual_2 );
//
//		$actual_3 = self::$hint_builder->get_file_type_mime( 'https://fonts.gstatic.com/s/raleway/v14/1Ptrg8zYS_SKggPNwK4vWqZPANqczVs.woff2' );
//		self::assertSame( '.woff2', $actual_3 );
//
//		$actual_4 = self::$hint_builder->get_file_type_mime( 'https://sphacks.local/wp-content/uploads/2021/04/cropped-cropped-fish-32x32.png' );
//		self::assertSame( '.png', $actual_4 );
//
//		$actual_5 = self::$hint_builder->get_file_type_mime( 'https://fonts.googleapis.com/css?family=Lato:300,300i,700,700i,900,400%7CPacifico:400&subset=latin,latin-ext&display=auto' );
//		self::assertSame( '', $actual_5 );
//	}
