...
class DAOControllerTest extends TestCase {
	...
	public function test_hint_controller() {
		...
		$expected_1 = \PPRH\DAO::create_db_result( true, $raw_data_1['op_code'], 0 );
		...
		$expected_2 = \PPRH\DAO::create_db_result( true, $raw_data_2['op_code'], 0 );
		...
		$expected_3 = \PPRH\DAO::create_db_result( true, $raw_data_3['op_code'], 0 );
		...
		$expected_4 = \PPRH\DAO::create_db_result( true, $raw_data_4['op_code'], 0 );
		...
		$expected_5 = \PPRH\DAO::create_db_result( true, $raw_data_5['op_code'], 0 );
