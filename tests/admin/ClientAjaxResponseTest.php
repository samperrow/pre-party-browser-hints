...
class ClientAjaxResponseTest extends TestCase {
	...
	public function test_post_domain_names() {
		...
		$hint_preconnect_1 = \PPRH\Utils::create_raw_hint( 'https://fonts.gstaticTest.com', self::$hint_type );
		$hint_preconnect_2 = \PPRH\Utils::create_raw_hint( 'https://fonts.gstaticTest2.com', self::$hint_type );
		...
		$hint_3 = \PPRH\Utils::create_raw_hint( '', self::$hint_type );
		 ...
		 * PRELOADS
		 */
//		$hint_preload_1 = \PPRH\Utils::create_raw_hint( 'https://example.com/assets/styles.css', 'preload' );
//		$hint_preload_2 = \PPRH\Utils::create_raw_hint( 'https://example.com/assets/scripts/js.js', 'preload' );
//
