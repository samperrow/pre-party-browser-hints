...
class SettingsSaveTest extends TestCase{
	...
	public function test_save_prefetch_settings () {
		...
		$post_2 = array('pprh_prefetch_enabled' => 'true', 'pprh_prefetch_disableForLoggedInUsers' => 'true', 'pprh_prefetch_delay' => '1', 'pprh_prefetch_ignoreKeywords' => 'asdf', 'pprh_prefetch_maxRPS' => '5', 'pprh_prefetch_hoverDelay' => '3', 'pprh_prefetch_max_prefetches' => '10');
