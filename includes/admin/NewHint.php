...
class NewHint {
	...
	protected function set_attrs() {
        ...
        <tr>
            ...
            <td colspan="1">
				<span class="pprh-help-tip-hint">
					<span><?php _e( 'For various reasons, font files (and others) need to be loaded with the crossorigin attribute. Crossorigin only applies to preconnect and preload hints.<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Preloading_content#Cross-origin_fetches">Source: Mozilla</a>',
                            'pprh' ); ?></span>
				</span>
        ...
        <tr>
            ...
            <td colspan="1">
				<p><?php esc_html_e( 'Media Attribute', 'pprh' ); ?>
                    <span class="pprh-help-tip-hint">
                        <span><?php _e( 'Specify the media attribute. This is only used with the preload resource hint. This can be used to allow hints to only load on certain devices, screen dimensions, and more. <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/Media_Queries/Using_media_queries">https://developer.mozilla.org/en-US/docs/Web/CSS/Media_Queries/Using_media_queries</a>', 'pprh' ); ?></span>
                    </span>
                </p>
            </td>
